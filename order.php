...
<div class="container">
	<h1 class="page-header text-center">Choose Item</h1>
	<form method="POST" action="purchase.php">
				...
				<?php 
					...
					while($row=$query->fetch_array()){
						...
						<tr>
							...
							<td class="text-right">BDT <?php echo number_format($row['price'], 2); ?></td>
		...
		<div class="row">
			...
			<div class="col-md-2" style="margin-left:-20px;">
				<button type="submit" class="btn btn-primary"><span class="glyphicon glyphicon-floppy-disk"></span> Place Order</button>
			</div>
		</div>
	</form>
</div>
